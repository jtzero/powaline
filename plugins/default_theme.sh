# root names that generate the segments # slowest first
GENERATORS=("LANGS_SEGMENTS" "GIT_SEGMENTS" "CWD_SEGMENTS" "NUMBER_OF_JOBS_SEGMENT" "USERNAME_SEGMENT" "TERMINATOR_SEGMENT")
...
GIT_SEGMENTS_FLAG_NAME="POWALINE_GIT_SEGMENTS_CHANGED_FLAG"
##
...
GIT_STAGED_SEGMENT_FLAG_NAME="${GIT_SEGMENTS_FLAG_NAME}"

GIT_MODIFIED_SEGMENT_SYMBOL=$'\u270e'
...
GIT_MODIFIED_SEGMENT_FLAG_NAME="${GIT_SEGMENTS_FLAG_NAME}"

# alt if q looks too big
GIT_UNTRACKED_SEGMENT_SYMBOL=$'\u003F'
#GIT_UNTRACKED_SEGMENT_SYMBOL=$'\u2753\]'
GIT_UNTRACKED_SEGMENT_BG=52
GIT_UNTRACKED_SEGMENT_FG=15
GIT_UNTRACKED_SEGMENT_MEMO_NAME="${GIT_SEGMENTS_MEMO_NAME}"
GIT_UNTRACKED_SEGMENT_FLAG_NAME="${GIT_SEGMENTS_FLAG_NAME}"
...
#SEPERATOR=$'\ue0b0'
#THIN_SEPERATOR=$'\ue0b1'
#GIT_BRANCH_SEGMENT_SYMBOL=$'\ue0a0'

#nerd font
LOCK=$'\uf023'
NETWORK=$'\uf98c'
PYTHON_SEGMENT_SYMBOL=$'\ue235'
NODEJS_SEGMENT_SYMBOL=$'\uf898'
ELIXIR_SEGMENT_SYMBOL=$'\ue62d'
RUBY_SEGMENT_SYMBOL=$'\ue791'
GIT_BRANCH_SEGMENT_SYMBOL=$'\ue0a0'
SEPERATOR=$'\ue0b0'
THIN_SEPERATOR=$'\ue0b1'
